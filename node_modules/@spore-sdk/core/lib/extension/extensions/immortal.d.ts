 ...
 */
export declare function useImmortal(): SporeExtension;
export declare function isImmortalParameterValid(immortal: unknown): boolean;
export declare function getImmortalParameter(): void;
